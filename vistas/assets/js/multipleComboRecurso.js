function MultiSelectTag(e,t={shadow:!1,rounded:!0}){
    var n=null,d=null,l=null,a=null,s=null,i=null,o=null,c=null,r=null,u=null,p=null,v=null,m=new DOMParser;
    function h(e=null){
        ...
        if(t.selected)!w(t.value)&&f(t);
            ...
            function f(e){
                ...
                n.classList.add("item-label"),n.innerHTML=e.label,n.dataset.value=e.value;const l=(new DOMParser).parseFromString('<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="item-close-svg">\n                <line x1="18" y1="6" x2="6" y2="18"></line>\n                <line x1="6" y1="6" x2="18" y2="18"></line>\n                </svg>',"image/svg+xml").documentElement;l.addEventListener("click",(t=>
                {
                ...
                function w(e){
                    ...
                    n=document.getElementById(e),function(){
                        d=[...n.options].map((e=>({
                            value:e.value,label:e.label,selected:e.selected
                        }))),
                        ...
                        r.placeholder=`${t.placeholder||"Buscar..."}`,
                        (c=document.createElement("inputBody")).classList.add("input-body"),
                        c.append(r),i.append(o),
                        (s=document.createElement("div")).classList.add("btn-container"),
                        (u=document.createElement("button")).type="button",
                        s.append(u);const e=m.parseFromString('<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">\n            <polyline points="18 15 12 21 6 15"></polyline></svg>',"image/svg+xml").documentElement;u.append(e),
                        i.append(s),
                        a.append(i),
                        (p=document.createElement("div")).classList.add("drawer","hidden"),
                        t.shadow&&p.classList.add("shadow"),
                        t.rounded&&p.classList.add("rounded"),
                        p.append(c),v=document.createElement("ul"),
                        p.appendChild(v),
                        l.appendChild(a),
                        l.appendChild(p),
                        n.nextSibling?n.parentNode.insertBefore(l,n.nextSibling):n.parentNode.appendChild(l)}(),h(),L(),E(),u.addEventListener("click",(()=>{
...
new MultiSelectTag('autorSeleccionarCbx');  // id lista autores en vista Nuevo Recurso
new MultiSelectTag('cursoSeleccionarCbx');  // id lista cursos en vista Nuevo Recurso
new MultiSelectTag('etiquetaSeleccionarCbx');  // id lista etiquetas en vista Nuevo Recurso