                ...
                <div class="content-modal-edit-record">
                    <form action="<?php echo SERVER_URL ?>ajax/programaAjax.php" class="FormularioAjax" method="POST" data-form="update" autocomplete="off">
                        ...
                        <div class="botones-accion-modal">
                            ...
                            <a href="<?php echo SERVER_URL ?>admin-programas/" class="btn-close-edit-record" title="Programas">Volver atrás</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php }else{ ?>
    <div class="errorEditContainer">
        ...
        <section class="img-section">
            ...
            <a href="<?php echo SERVER_URL; ?>admin-programas/" class="btn-UserNotFound" title="Ir a programas">Volver atrás</a>
        </section>
    </div>
<?php } ?>