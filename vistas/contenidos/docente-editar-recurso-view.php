...
if($consultaRecursos->rowCount() > 0){
    ...
    $listaAutores = $insAutor->paginadorAutorControlador(null);
    $listaCursos = $insCurso->paginadorCursoControlador();
    $listaEtiquetas = $insEtiqueta->paginadorEtiquetaControlador(null);
        ...
        <div class="title">
            ...
            <div class="container-modal-edit-record" id="modal-container-edit-user">
                ...
                <form action="<?php echo SERVER_URL ?>ajax/recursoAjax.php" class="sign-up-form FormularioAjax" method="POST" data-form="save_resource" autocomplete="off" enctype="multipart/form-data">
                    <input type="hidden" name="id_docente_recurso_edit" value="<?php echo $pagina[1] ?>">
                    <!--Título recurso-->
                    <div class="input-field">
                        <input name="titulo_docente_edit" type="text" maxlength="250" value="<?php echo $datosRecurso['titulo']?>" placeholder="Título *" title="Por favor, complete el campo" required/>
                    </div>
                    <!--Lista de autores-->
                    <label for="autorSeleccion" class="titleComboMultiple">Autor(es)</label>
                        <select name="autores_docente_edit[]" id="autorSeleccionarCbx" multiple="multiple" title="Por favor, selecciona el o los autores del recurso">
                            <?php
                    ...
                    <!--Resumen-->
                    <textarea class="textAreaStl" name="resumen_docente_edit" maxlength="1500" type="text" placeholder="Resumen *" title="Por favor, complete el campo" required><?php echo $datosRecurso['resumen'] ?></textarea>
                    <!--Año recurso-->
                    <div class="input-field">
                        <input name="anioRecurso_docente_edit" type="number" value="<?php echo $datosRecurso['fecha_publicacion_recurso'] ?>" placeholder="Año de creación" min="1700" pattern="[0-9]+" title="Por favor, complete el campo"/>
                    </div>
                    <!--Lista de cursos-->
                    <label for="cursoSeleccion" class="titleComboMultiple">Curso (s) *</label>
                        <select name="cursos_docente_edit[]" id="cursoSeleccionarCbx" multiple="multiple" title="Por favor, selecciona el o los programas asociados al recurso">
                            <?php
                    ...
                    <label for="etiquetaSeleccion" class="titleComboMultiple">Palabra(s) clave</label>
                        <select name="etiquetas_docente_edit[]" id="etiquetaSeleccionarCbx" multiple="multiple" title="Por favor, selecciona la o las palabras clave para el recurso">
                            <?php
                    ...
                    <!--Editorial-->
                    <div class="input-field">
                        <input name="editorial_docente_edit" type="text" maxlength="80" placeholder="Editorial " value="<?php echo $datosRecurso['editorial'] ?>" title="Por favor, complete el campo"/>
                    </div>
                    <!--ISBN-->
                    <div class="input-field">
                        <input name="ISBN_docente_edit" type="number" maxlength="20" placeholder="ISBN" value="<?php echo $datosRecurso['isbn'] ?>" title="Por favor, complete el campo"/>
                    </div>
                    <!--Link del recurso-->
                    <div class="input-field">
                        <input name="link_docente_edit" type="text" maxlength="300" placeholder="Enlace" value="<?php echo $datosRecurso['enlace'] ?>" title="Por favor, complete el campo"/>
                    </div>
                    <!--Estados-->
                    <div class="input-field ">
                        <div class="select-option">
                            <select name="estado_docente_edit" class="combobox-titulo" title="Estado del curso">
