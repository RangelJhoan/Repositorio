...
$datos_autores = $ins_autor->paginadorAutorControlador(null);
$datos_etiquetas = $ins_etiqueta->paginadorEtiquetaControlador(null);
$datos_cursos = $ins_curso->paginadorCursoControlador();
?>
