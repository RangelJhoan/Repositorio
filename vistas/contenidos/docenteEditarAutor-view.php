            ...
            <div class="container-modal-edit-record" id="modal-container-edit-user">
                <div class="content-modal-edit-record">
                    ...
                    <div class="input-field">
                            <input name="nombre_doc_edit" type="text" value="<?php echo $campos['nombre'] ?>" placeholder="Nombres" title="Por favor, complete el campo"/>
                        </div>
                        <div class="input-field">
                            <input name="apellido_doc_edit" type="text" value="<?php echo $campos['apellido'] ?>" placeholder="Apellidos *" title="Por favor, complete el campo" required/>
                        </div>
                        <!--Select tag-->
                        <div class="input-field ">
