        ...
        <div class="overview-general-admin">
            ...
            <div class="container-modal-edit-record" id="modal-container-edit-user">
                <div class="content-modal-edit-record">
                    ...
                    <input type="hidden" name="id_docente_etiqueta_edit" value="<?php echo $pagina[1] ?>">
                        <div class="input-field">
                            <input name="descripcion_docente_edit" type="text" value="<?php echo $campos['descripcion'] ?>" placeholder="Descripcion *" title="Por favor, complete el campo" required/>
                        </div>
                        <!--Select tag-->
                        <div class="input-field ">
