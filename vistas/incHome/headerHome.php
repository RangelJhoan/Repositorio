    ...
    <nav class="nav-Home-Main">
        ...
        <form class="form-BarraBusquedaHome" action="<?php echo SERVER_URL ?>ajax/homeAjax.php" method="POST" data-form="save" autocomplete="off">
            <div class="searchBar-Container">
                <input class="input-SearchBar" type="text" name="barraBusqueda" placeholder="Buscar recurso..." value="<?php if(isset($pagina[2]))echo $ins_homec->cargarBusqueda($pagina[2]); ?>">
